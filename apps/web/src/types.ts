...
export type Pomodoro = { workspaceId: string; status: "IDLE" | "RUNNING" | "PAUSED"; phase: "FOCUS" | "BREAK"; durationSeconds: number; breakDurationSeconds: number; remainingSeconds: number; startedAt: string | null; endsAt: string | null; updatedAt: string };
...
export type ActivityDay = { date: string; seconds: number; boards: { id: string; title: string; seconds: number }[] };
